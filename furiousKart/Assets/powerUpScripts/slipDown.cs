...
public class slipDown : MonoBehaviour
{
                                         ...
                                         * pass in the other variable which is now a reference to the player.*/
    {
        ...
        kartController = player.GetComponent<CarController>(); // by applying the collider directly to the parent class with the player tag, it no longer requires a reference to the playercar. 
        kartController.slipDown = true;
